        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text26">About DAVE</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url1} className="thq-link thq-body-small">
              {props.link21 ?? (
                <Fragment>
                  <span className="navbar8-text18">About DAVE</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <div className="navbar8-icon-container1">
                ...
                {!link5DropdownVisible && (
                  <div className="navbar8-container3"></div>
                )}
              </div>
            </div>
          </nav>
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text23">Delegate to DAVE</span>
                  </Fragment>
                )}
              </span>
            </button>
            ...
            >
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text24">Apex Fusion</span>
                  </Fragment>
                )}
              </span>
            </a>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text15">About Me</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
...
Navbar8.defaultProps = {
  logoAlt: 'Stakepool Logo',
  linkUrlPage1: 'https://www.teleporthq.io',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1519408469771-2586093c3f14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzg0MzYyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  link4: undefined,
  rootClassName: '',
  ...
  action2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1481487196290-c152efe083f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzg0MzYyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  page4: undefined,
  link2: undefined,
  page4ImageAlt: 'image',
  page2ImageAlt: 'image',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1662405624151-57183b6773d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzg0MzYyNnw&ixlib=rb-4.0.3&q=80&w=1080',
